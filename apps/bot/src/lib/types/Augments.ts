...
import type { AkiraMetrics } from '#lib/observability/AkiraMetrics';
...
import type { AkiraErrors } from '#lib/types/Enums';
...
declare module 'discord.js' {
	...
	interface ClientEvents {
		[AkiraErrors.WebhookError]: [error: unknown];
		[AkiraErrors.ChannelPermissions]: [payload: ChannelPermissionsPayload];
	}
